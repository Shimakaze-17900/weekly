...
但当我们切换到汇编,就能看到所有没有显示的逻辑:

```assembly
.text:000000010000C0E0 anti_debug_1    proc near               ; CODE XREF: anti_debug_and_init+190F↑p
.text:000000010000C0E0                                         ; DATA XREF: .pdata:0000000100024354↓o
.text:000000010000C0E0
.text:000000010000C0E0 var_A8          = qword ptr -0A8h
.text:000000010000C0E0 var_A0          = dword ptr -0A0h
.text:000000010000C0E0 var_98          = qword ptr -98h
.text:000000010000C0E0 var_90          = qword ptr -90h
.text:000000010000C0E0 var_88          = dword ptr -88h
.text:000000010000C0E0 var_84          = byte ptr -84h
.text:000000010000C0E0 var_80          = qword ptr -80h
.text:000000010000C0E0 var_78          = dword ptr -78h
.text:000000010000C0E0 var_70          = qword ptr -70h
.text:000000010000C0E0 var_68          = qword ptr -68h
.text:000000010000C0E0 var_60          = dword ptr -60h
.text:000000010000C0E0 var_5C          = byte ptr -5Ch
.text:000000010000C0E0 var_18          = dword ptr -18h
.text:000000010000C0E0 var_14          = dword ptr -14h
.text:000000010000C0E0 arg_0           = qword ptr  8
.text:000000010000C0E0
.text:000000010000C0E0 ; FUNCTION CHUNK AT .text:0000000100017960 SIZE 00000015 BYTES
.text:000000010000C0E0
.text:000000010000C0E0 ; __unwind { // __C_specific_handler
.text:000000010000C0E0                 mov     [rsp+arg_0], rcx
.text:000000010000C0E5                 push    rdi
.text:000000010000C0E6                 sub     rsp, 0C0h
.text:000000010000C0ED
...
.text:000000010000C0FF                 call    cs:IsDebuggerPresent
.text:000000010000C105                 test    eax, eax
.text:000000010000C107                 jz      short loc_10000C113
.text:000000010000C109                 mov     [rsp+0C8h+var_84], 1
.text:000000010000C10E                 jmp     loc_10000C1C0
.text:000000010000C113 ; ---------------------------------------------------------------------------
.text:000000010000C113
.text:000000010000C113 loc_10000C113:                          ; CODE XREF: anti_debug_1+27↑j
.text:000000010000C113                 mov     rax, gs:60h
.text:000000010000C11C                 mov     [rsp+0C8h+var_A8], rax
.text:000000010000C121                 mov     rax, [rsp+0C8h+var_A8]
.text:000000010000C126                 movzx   eax, byte ptr [rax+2]
.text:000000010000C12A                 test    eax, eax
.text:000000010000C12C                 jz      short loc_10000C138
.text:000000010000C12E                 mov     [rsp+0C8h+var_84], 1
.text:000000010000C133                 jmp     loc_10000C1C0
.text:000000010000C138 ; ---------------------------------------------------------------------------
.text:000000010000C138
.text:000000010000C138 loc_10000C138:                          ; CODE XREF: anti_debug_1+4C↑j
.text:000000010000C138                 call    cs:GetTickCount64
.text:000000010000C13E                 mov     [rsp+0C8h+var_90], rax
.text:000000010000C143                 mov     [rsp+0C8h+var_A0], 0
.text:000000010000C14B                 mov     [rsp+0C8h+var_88], 0
.text:000000010000C153                 jmp     short loc_10000C15F
.text:000000010000C155 ; ---------------------------------------------------------------------------
.text:000000010000C155
.text:000000010000C155 loc_10000C155:                          ; CODE XREF: anti_debug_1+99↓j
.text:000000010000C155                 mov     eax, [rsp+0C8h+var_88]
.text:000000010000C159                 inc     eax
.text:000000010000C15B                 mov     [rsp+0C8h+var_88], eax
.text:000000010000C15F
.text:000000010000C15F loc_10000C15F:                          ; CODE XREF: anti_debug_1+73↑j
.text:000000010000C15F                 cmp     [rsp+0C8h+var_88], 3E8h
.text:000000010000C167                 jge     short loc_10000C17B
.text:000000010000C169                 mov     eax, [rsp+0C8h+var_88]
.text:000000010000C16D                 mov     ecx, [rsp+0C8h+var_A0]
.text:000000010000C171                 add     ecx, eax
.text:000000010000C173                 mov     eax, ecx
.text:000000010000C175                 mov     [rsp+0C8h+var_A0], eax
.text:000000010000C179                 jmp     short loc_10000C155
.text:000000010000C17B ; ---------------------------------------------------------------------------
.text:000000010000C17B
.text:000000010000C17B loc_10000C17B:                          ; CODE XREF: anti_debug_1+87↑j
.text:000000010000C17B                 call    cs:GetTickCount64
.text:000000010000C181                 mov     [rsp+0C8h+var_98], rax
.text:000000010000C186                 mov     rax, [rsp+0C8h+var_90]
.text:000000010000C18B                 mov     rcx, [rsp+0C8h+var_98]
.text:000000010000C190                 sub     rcx, rax
.text:000000010000C193                 mov     rax, rcx
.text:000000010000C196                 cmp     rax, 2
.text:000000010000C19A                 jbe     short loc_10000C1A9
.text:000000010000C19C                 mov     [rsp+0C8h+var_18], 1
.text:000000010000C1A7                 jmp     short loc_10000C1B4
.text:000000010000C1A9 ; ---------------------------------------------------------------------------
.text:000000010000C1A9
.text:000000010000C1A9 loc_10000C1A9:                          ; CODE XREF: anti_debug_1+BA↑j
.text:000000010000C1A9                 mov     [rsp+0C8h+var_18], 0
.text:000000010000C1B4
.text:000000010000C1B4 loc_10000C1B4:                          ; CODE XREF: anti_debug_1+C7↑j
.text:000000010000C1B4                 movzx   eax, byte ptr [rsp+0C8h+var_18]
.text:000000010000C1BC                 mov     [rsp+0C8h+var_84], al
.text:000000010000C1C0
.text:000000010000C1C0 loc_10000C1C0:                          ; CODE XREF: anti_debug_1+2E↑j
.text:000000010000C1C0                                         ; anti_debug_1+53↑j
.text:000000010000C1C0                 movzx   eax, [rsp+0C8h+var_84]
.text:000000010000C1C5                 test    eax, eax
.text:000000010000C1C7                 jz      loc_10000C2A7
.text:000000010000C1CD                 call    cs:IsDebuggerPresent
.text:000000010000C1D3                 test    eax, eax
.text:000000010000C1D5                 jz      short loc_10000C1E1
.text:000000010000C1D7                 mov     [rsp+0C8h+var_5C], 1
.text:000000010000C1DC                 jmp     loc_10000C28E
.text:000000010000C1E1 ; ---------------------------------------------------------------------------
.text:000000010000C1E1
.text:000000010000C1E1 loc_10000C1E1:                          ; CODE XREF: anti_debug_1+F5↑j
.text:000000010000C1E1                 mov     rax, gs:60h
.text:000000010000C1EA                 mov     [rsp+0C8h+var_80], rax
.text:000000010000C1EF                 mov     rax, [rsp+0C8h+var_80]
.text:000000010000C1F4                 movzx   eax, byte ptr [rax+2]
.text:000000010000C1F8                 test    eax, eax
.text:000000010000C1FA                 jz      short loc_10000C206
.text:000000010000C1FC                 mov     [rsp+0C8h+var_5C], 1
.text:000000010000C201                 jmp     loc_10000C28E
.text:000000010000C206 ; ---------------------------------------------------------------------------
.text:000000010000C206
.text:000000010000C206 loc_10000C206:                          ; CODE XREF: anti_debug_1+11A↑j
.text:000000010000C206                 call    cs:GetTickCount64
.text:000000010000C20C                 mov     [rsp+0C8h+var_68], rax
.text:000000010000C211                 mov     [rsp+0C8h+var_78], 0
.text:000000010000C219                 mov     [rsp+0C8h+var_60], 0
.text:000000010000C221                 jmp     short loc_10000C22D
.text:000000010000C223 ; ---------------------------------------------------------------------------
.text:000000010000C223
.text:000000010000C223 loc_10000C223:                          ; CODE XREF: anti_debug_1+167↓j
.text:000000010000C223                 mov     eax, [rsp+0C8h+var_60]
.text:000000010000C227                 inc     eax
.text:000000010000C229                 mov     [rsp+0C8h+var_60], eax
.text:000000010000C22D
.text:000000010000C22D loc_10000C22D:                          ; CODE XREF: anti_debug_1+141↑j
.text:000000010000C22D                 cmp     [rsp+0C8h+var_60], 3E8h
.text:000000010000C235                 jge     short loc_10000C249
.text:000000010000C237                 mov     eax, [rsp+0C8h+var_60]
.text:000000010000C23B                 mov     ecx, [rsp+0C8h+var_78]
.text:000000010000C23F                 add     ecx, eax
.text:000000010000C241                 mov     eax, ecx
.text:000000010000C243                 mov     [rsp+0C8h+var_78], eax
.text:000000010000C247                 jmp     short loc_10000C223
.text:000000010000C249 ; ---------------------------------------------------------------------------
.text:000000010000C249
.text:000000010000C249 loc_10000C249:                          ; CODE XREF: anti_debug_1+155↑j
.text:000000010000C249                 call    cs:GetTickCount64
.text:000000010000C24F                 mov     [rsp+0C8h+var_70], rax
.text:000000010000C254                 mov     rax, [rsp+0C8h+var_68]
.text:000000010000C259                 mov     rcx, [rsp+0C8h+var_70]
.text:000000010000C25E                 sub     rcx, rax
.text:000000010000C261                 mov     rax, rcx
.text:000000010000C264                 cmp     rax, 2
.text:000000010000C268                 jbe     short loc_10000C277
.text:000000010000C26A                 mov     [rsp+0C8h+var_14], 1
.text:000000010000C275                 jmp     short loc_10000C282
.text:000000010000C277 ; ---------------------------------------------------------------------------
.text:000000010000C277
.text:000000010000C277 loc_10000C277:                          ; CODE XREF: anti_debug_1+188↑j
.text:000000010000C277                 mov     [rsp+0C8h+var_14], 0
.text:000000010000C282
.text:000000010000C282 loc_10000C282:                          ; CODE XREF: anti_debug_1+195↑j
.text:000000010000C282                 movzx   eax, byte ptr [rsp+0C8h+var_14]
.text:000000010000C28A                 mov     [rsp+0C8h+var_5C], al
.text:000000010000C28E
.text:000000010000C28E loc_10000C28E:                          ; CODE XREF: anti_debug_1+FC↑j
.text:000000010000C28E                                         ; anti_debug_1+121↑j
.text:000000010000C28E                 movzx   eax, [rsp+0C8h+var_5C]
.text:000000010000C293                 test    eax, eax
.text:000000010000C295                 jz      short loc_10000C2A7
.text:000000010000C297                 mov     rdi, cs:data
.text:000000010000C29E                 xor     eax, eax
.text:000000010000C2A0                 mov     ecx, 1000h
.text:000000010000C2A5                 rep stosb
.text:000000010000C2A7
.text:000000010000C2A7 loc_10000C2A7:                          ; CODE XREF: anti_debug_1+E7↑j
.text:000000010000C2A7                                         ; anti_debug_1+1B5↑j
.text:000000010000C2A7                 xor     eax, eax
.text:000000010000C2A9                 test    eax, eax
.text:000000010000C2AB                 jnz     loc_10000C0FF
.text:000000010000C2B1                 mov     rcx, [rsp+0C8h+arg_0]
.text:000000010000C2B9                 call    init_addtable
.text:000000010000C2BE                 nop
.text:000000010000C2BF
.text:000000010000C2BF loc_10000C2BF:                          ; CODE XREF: anti_debug_1+1A↑j
.text:000000010000C2BF                 add     rsp, 0C0h
.text:000000010000C2C6                 pop     rdi
.text:000000010000C2C7                 retn
.text:000000010000C2C7 ; } // starts at 10000C0E0
.text:000000010000C2C7 anti_debug_1    endp
```

我们发现它会使用`IsDebuggerPresent` 检查有没有被调试,`GetTickCount64`则很有可能是通过检测两次获得时间间的间隔来判断有没有被调试.
